...
import { Button, FormControl, IconButton, InputLabel, MenuItem, Paper, Select, SelectChangeEvent, styled, Table, TableBody, TableCell, tableCellClasses, TableContainer, TableHead, TableRow } from '@mui/material'
import React, { useEffect, useState } from 'react'
import { useAppDispatch, useAppSelector } from '../../../State/Store';
import { getAllDeals } from '../../../State/Admin/DealsSlice';
        ...
        <TableBody>
          {deals.deals.map((deal,index) => (
            <StyledTableRow key={deal.id}>
              ...
              <StyledTableCell>
                <img className='w-20 h-25 rounded-md' src={deal.category.images} alt="" />
              </StyledTableCell>
