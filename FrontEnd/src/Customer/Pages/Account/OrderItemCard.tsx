...
const navigate = useNavigate()
  ...
  return (
    ...
    <div onClick={() => navigate(`/account/order/${order.id}/${item.id}`)} className='text-sm bg-white p-5 space-y-4 border rounded-md9 cursor-pointer'>
      <div className='flex items-center gap-5'>
        ...
        <div>
          <h1 className='font-semibold text-primary-color'>{order.orderstatus}</h1>
